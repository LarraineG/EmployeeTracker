...
const updateEmployeeQs = async () => {
    ...
    inquirer.prompt([
        ...
        if (response.userchoice === "Department") {
            ...
            inquirer.prompt([
                {
                    message: "What duties would you like to assign?",
                    name: "newduties",
                    type: "list",
                    choices: dutiesArray
                }
...
// view each table: departments, duties, employees
// insert to each table: departments, duties, employees
// update employee duty

// if time allows...
// update an employee's manager
// view employees my manager
// delete departments, duties, and employees